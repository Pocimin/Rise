...
void InitializeClient() {
    ...
    FileUtils::debugOutput("[Rise] Injected!");
    FileUtils::debugOutput("[Rise] Initializing!");
    InitializeMods(); // This is used to initialize modules & sort categories.
    FileUtils::debugOutput("[Rise] Initialized Modules (1/3)");
    Authentication::Authorize();
    CommandMgr.InitializeCommands(); // This is used to initialize commands.
    FileUtils::debugOutput("[Rise] Initialized Commands (2/3)");
    InitializeHooks(); // This is used to initialize hooks to the proccess.
    FileUtils::debugOutput("[Rise] Initialized Hooks (3/3)");
    Global::Notification.addNotification("Rise", "Initialized!", 3);
    setWindowTitle(L"Rise Client");
}
