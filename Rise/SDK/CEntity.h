...
public:
	...
	Vector3i block; //0x0858
	Vector3 rayHitVec; //0x0864
...
public:
	float width; //0x044C
	float height; //0x0450
	Vector3 currentPos; //0x0454
	Vector3 oldPos; //0x0460
	Vector3 velocity; //0x046C
private:
...
public:
	...
	virtual Vector3* getPos(void)const;
	virtual Vector3* getPosOld(void)const;
	virtual Vector3* getPosExtrapolated(float)const;
private:
...
private:
	virtual __int64 move(Vector3 const&);
	...
	virtual __int64 teleportTo(Vector3 const&, bool, int, int);
	virtual __int64 tryTeleportTo(Vector3 const&, bool, bool, int, int);
	virtual void chorusFruitTeleport(Vector3&);
	virtual __int64 lerpTo(Vector3 const&, Vector2 const&, int);
public:
...
private:
	...
	virtual __int64 intersects(Vector3 const&, Vector3 const&)const;
public:
	virtual bool isFree(Vector3 const&, float);
...
public:
	...
	virtual bool canSee(Vector3 const&)const;
...
private:
	...
	virtual __int64 rideLanded(Vector3 const&, Vector3 const&);
...
private:
	...
	virtual __int64 onBounceStarted(Vector3i const&, __int64 const&);
...
private:
	...
	virtual __int64 handleInsidePortal(Vector3i const&);
...
private:
	...
	virtual __int64 playSynchronizedSound(__int64, Vector3 const&, __int64 const&, bool);
	virtual __int64 playSynchronizedSound(__int64, Vector3 const&, int, bool);
...
private:
	...
	virtual __int64 getInteraction(C_Player &, __int64 &, Vector3 const&);
public:
...
private:
	...
	virtual __int64 _playStepSound(Vector3i const&, __int64 const&);
	virtual __int64 _playFlySound(Vector3i const&, __int64 const&);
	virtual __int64 _makeFlySound(void)const;
	virtual __int64 checkInsideBlocks(float);
	virtual __int64 pushOutOfBlocks(Vector3 const&);
...
private:
	...
	virtual __int64 _getWalkTargetValue(Vector3i const&);
public:
...
private:
	...
	virtual __int64 moveSpawnView(Vector3 const&);
public:
	virtual void setName(std::string const&);
private:
	virtual __int64 checkMovementStats(Vector3 const&);
...
private:
	virtual __int64 startCrafting(Vector3i const&, bool);
	virtual __int64 startStonecutting(Vector3i const&);
	virtual __int64 startDestroying(void);
	virtual __int64 stopDestroying(void);
	virtual __int64 openContainer(Vector3i const&);
	virtual __int64 openContainer(__int64 const&);
	virtual __int64 openFurnace(Vector3i const&);
	virtual __int64 openBlastFurnace(Vector3i const&);
	virtual __int64 openSmoker(Vector3i const&);
	virtual __int64 openEnchanter(Vector3i const&);
	virtual __int64 openAnvil(Vector3i const&);
	virtual __int64 openGrindstone(Vector3i const&);
	virtual __int64 openBrewingStand(Vector3i const&);
	virtual __int64 openHopper(Vector3i const&);
	virtual __int64 openHopper(__int64 const&);
	virtual __int64 openDispenser(Vector3i const&, bool);
	virtual __int64 openBeacon(Vector3i const&);
	virtual __int64 openPortfolio(void);
	virtual __int64 openBook(int, bool, int, __int64*);
	virtual __int64 openCommandBlock(Vector3i const&);
...
private:
	...
	virtual __int64 openStructureEditor(Vector3i const&);
	virtual __int64 openLabTable(Vector3i const&);
	virtual __int64 openElementConstructor(Vector3i const&);
	virtual __int64 openCompoundCreator(Vector3i const&);
	virtual __int64 openMaterialReducer(Vector3i const&);
	virtual __int64 openLoom(Vector3i const&);
	virtual __int64 openStonecutter(Vector3i const&);
	virtual __int64 openCartographyTable(Vector3i const&);
	...
	virtual __int64 startSleepInBed(Vector3i const&);
...
private:
	...
	virtual __int64 openSign(Vector3i const&);
public:
...
public:
	...
	virtual bool isPositionRelevant(__int64, int, Vector3i const&);
...
private:
	...
	virtual __int64 onMoveC_PlayerPacketNormal(Vector3 const&, Vector2 const&, float);
};
