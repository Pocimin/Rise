...
private:
	...
	virtual __int64 dispense(C_BlockSource&, __int64&, int, Vector3 const&, unsigned char)const;
...
private:
	...
	virtual __int64 _checkUseOnPermissions(C_Entity&, __int64&, unsigned char const&, Vector3i const&)const;
	virtual __int64 _checkUseOnPermissions(C_Entity&, C_ItemStack&, unsigned char const&, Vector3i const&)const;
	virtual __int64 _calculatePlacePos(__int64&, C_Entity&, unsigned char&, Vector3i&)const;
	virtual __int64 _calculatePlacePos(C_ItemStack&, C_Entity&, unsigned char&, Vector3i&)const;
	virtual __int64 _useOn(__int64&, C_Entity&, Vector3i, unsigned char, float, float, float)const;
	virtual __int64 _useOn(C_ItemStack&, C_Entity&, Vector3i, unsigned char, float, float, float)const;
public:
