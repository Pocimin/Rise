...
public:
	...
	static float	Dimension_getSunIntensity(__int64, float a2, Vector3* a3, float a4);
	static void		ChestBlockActor_tick(C_ChestBlockActor*, void* a);
	static void		Actor_lerpMotion(C_Entity* _this, Vector3);
	...
	static void		GameMode_startDestroyBlock(C_GameMode* _this, Vector3i* a2, uint8_t face, void* a4, void* a5);
