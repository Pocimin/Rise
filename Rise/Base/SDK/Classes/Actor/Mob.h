...
// Mob VTable
class Mob : public Actor { // 1.20.80
public:
	...
	virtual void hurtArmorSlots(int, ItemStack const&, ItemStack const&);
	...
	virtual void dropEquipmentOnDeath(ActorDamageSource const&);
	...
	virtual void setItemSlot(int, ItemStack const&, ItemStack const&);
