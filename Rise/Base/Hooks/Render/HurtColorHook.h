...
public:
	...
	bool Initialize() override // Now override the Initialize function so we can actually hook our stuff
	{
		...
		void* HurtColorAddr = Utils::findSig(xorstr_("E8 ? ? ? ? E9 ? ? ? ? 8B 43 ? 48 8D 54 24"));
		...
		return Utils::HookFunction((void*)HurtColorFunc, (void*)&HurtColorDetour, &onHurtColor, xorstr_("HurtColor"));
