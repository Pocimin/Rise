...
public:
    bool Initialize() override // Now override the Initialize function so we can actually hook our stuff
    {
        ...
        void* containerTickAddr = Utils::findSig(xorstr_("48 8B C4 48 89 58 10 48 89 68 18 48 89 70 20 57 41 56 41 57 48 81 EC ? ? ? ? 0F 29 70 D8 4C 8B F1 48 8B 89 ? ? ? ? E8 ? ? ? ?"));
        ...
        return Utils::HookFunction(containerTickAddr, (void*)&ContainerTickDetour, &onContainerTick, xorstr_("ContainerTick"));
