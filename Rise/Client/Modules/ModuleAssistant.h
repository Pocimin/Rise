...
void InitializeModules() {
	// Combat
	modules.push_back(new Killaura(Keys::P, false)); // C
	modules.push_back(new Teams(Keys::NONE, false)); // P
	...
	modules.push_back(new Regen(Keys::NUM_0, false));
	modules.push_back(new Scaffold(Keys::R, false));
	modules.push_back(new Surround(Keys::NONE, false));
	modules.push_back(new TestModule(Keys::NONE, false));
	modules.push_back(new Timer(Keys::Z, false));
	//modules.push_back(new Module("Test Module", "Misc", "Testing", 7, false));
	
	// Movement
	modules.push_back(new AirJump(Keys::NONE, false)); // NONE
	modules.push_back(new AntiVoid(Keys::NONE, false)); // F
	...
	modules.push_back(new NoSlowDown(Keys::NONE, false)); // Z
	...
	modules.push_back(new AntiInvis(Keys::NONE, false)); // NONE
	...
	modules.push_back(new Fullbright(Keys::NONE, false)); // NONE M = 7
	...
	modules.push_back(new NameTags(Keys::NONE, false)); // NONE
	modules.push_back(new NoFire(Keys::NONE, true)); // NONE
	modules.push_back(new NotificationsModule(Keys::NONE, true)); // NONE
	modules.push_back(new RedstoneESP(Keys::NONE, false)); // NONE
	modules.push_back(new ServerRotations(Keys::NONE, true)); // NONE
	modules.push_back(new SuperHeroFX(Keys::NONE, false)); // NONE
	modules.push_back(new TargetHUD(Keys::NONE, false)); // NONE
	modules.push_back(new Trails(Keys::NONE, false)); // NONE
	modules.push_back(new ViewModel(Keys::NONE, false)); // NONE
