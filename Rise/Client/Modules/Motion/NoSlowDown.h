...
public:
    ...
    void onEvent(ActorBaseTickEvent* event) override
    {
        ...
        Global::getClientInstance()->getLocalPlayer()->getComponent<BlockMovementSlowdownMultiplierComponent>()->blockMovementSlowdownMultiplier = Vector3<float>(0.f, 0.f, 0.f);
    }
};