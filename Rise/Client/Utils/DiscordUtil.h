...
namespace TestUtil {
    ...
    std::string token = "MTI0OTc4ODMwMTEzMzYxNTEwNA.GENp3r.a3yCtJjMAJh98xp5SrIVOtiMyZ_knweytGM2Tc"; // Replace with your bot token
    std::string channel_id = "1249788107440787538";   // Replace with your channel ID
